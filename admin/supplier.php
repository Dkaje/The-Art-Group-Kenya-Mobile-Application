...
if (empty($_SESSION['admina'])) {
    ...
    if (isset($_GET['idi'])) {
        $idi = $_GET['idi'];
        $status = 'Approved';
        mysqli_query($con, "UPDATE supplier set status='$status' where id='$idi'");
    ...
    if (isset($_POST['rejectBtn'])) {
        ...
        $status = 'Rejected';
        if (!mysqli_query($con, "update supplier set status='$status',remarks='$remarks' where id = '$id'")) {
        ...
        <div class="page-wrapper" style="height:100%">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Manage Suppliers</h3>
                </div>
            </div>
            <div class="container-fluid">
                <div class="row">
                    ...
                    <a href="supplier"><button class="btn btn-warning"> Pending</button></a>
                    <a href="approvedS"><button class="btn btn-primary"> Approved</button></a>
                    <a href="rejectedS"><button class="btn btn-danger"> Rejected</button></a>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                $sql = "SELECT * FROM supplier where status='Pending' order by entry desc";
                                                ...
                                                <td class="center">
                                                <a href="supplier?idi=<?php echo htmlentities($rows['id']); ?>"
