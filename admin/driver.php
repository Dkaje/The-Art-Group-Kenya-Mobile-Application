...
if (empty($_SESSION['admina'])) {
    ...
    if (isset($_GET['idi'])) {
        $idi = $_GET['idi'];
        $status = 'Approved';
        mysqli_query($con, "UPDATE driver set status='$status' where id='$idi'");
    ...
    if (isset($_POST['rejectBtn'])) {
        ...
        $status = 'Rejected';
        if (!mysqli_query($con, "update driver set status='$status',remarks='$remarks' where id = '$id'")) {
        ...
        <div class="page-wrapper" style="height:100%">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <a href="driver"><button class="btn btn-warning"> Pending</button></a>
                    <a href="approvedD"><button class="btn btn-primary"> Approved</button></a>
                    <a href="rejectedD"><button class="btn btn-danger"> Rejected</button></a>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                $sql = "SELECT * FROM driver where status='Pending' order by entry desc";
                                                ...
                                                <td class="center">
                                                <a href="driver?idi=<?php echo htmlentities($rows['id']); ?>"
