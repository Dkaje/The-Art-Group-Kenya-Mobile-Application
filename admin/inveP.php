...
if (empty($_SESSION['admina'])) {
    ...
    if (isset($_POST['rejectBtn'])) {
        ...
        if (!mysqli_query($con, "update staff set status='$status',remarks='$remarks' where id = '$id'")) {
            ...
            echo "<script>location.href='inveP' </script>";
        }
    }
?>
        ...
        <div class="page-wrapper" style="height:100%">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Manage System StoreKeeper</h3>
                </div>
            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                $sql = "SELECT * FROM staff where status='Pending' and role='Inventory' order by entry desc";
                                                ...
                                                <td class="center">
                                                <a href="inveP?idi=<?php echo htmlentities($rows['id']); ?>"
