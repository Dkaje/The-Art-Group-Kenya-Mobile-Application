        ...
        <div class="page-wrapper" style="height:100%">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Rejected System Finance</h3>
                </div>
            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                $sql = "SELECT * FROM staff where status='Rejected' and role='Finance' order by entry desc";
                                                ...
                                                <td class="center">
                                                <a href="finaR.php?idi=<?php echo htmlentities($rows['id']); ?>"
