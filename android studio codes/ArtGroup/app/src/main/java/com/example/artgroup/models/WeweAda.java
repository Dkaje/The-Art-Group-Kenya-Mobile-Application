...
public class WeweAda extends ArrayAdapter<RecentMode> {
    public ArrayList<RecentMode> MainList;
    public ArrayList<RecentMode> SubjectListTemp;
    public WeweAda.SubjectDataFilter subjectDataFilter;

    public WeweAda(Context context, int id, ArrayList<RecentMode> subjectArrayList) {
