...
public class NoMoreDis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_no_more_dis);
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            tortureAda = new TortureAda(NoMoreDis.this, R.layout.okay, tortureModeArrayList);
