...
public class RecentAda extends ArrayAdapter<RecentMode> {
    public ArrayList<RecentMode> MainList;
    public ArrayList<RecentMode> SubjectListTemp;
    public RecentAda.SubjectDataFilter subjectDataFilter;

    public RecentAda(Context context, int id, ArrayList<RecentMode> subjectArrayList) {
