...
public class MessageFina extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_message_fina);
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            tortureAda = new TortureAda(MessageFina.this, R.layout.okay, tortureModeArrayList);
