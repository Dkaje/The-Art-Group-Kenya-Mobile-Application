...
public class BidAda extends ArrayAdapter<BidModel> {
    public ArrayList<BidModel> bidModels;
    public ArrayList<BidModel> bidModelArrayList;
    public BidDateFilter bidDateFilter;

    public BidAda(Context context, int id, ArrayList<BidModel> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(R.layout.marathon, null);
        ...
        BidModel subject = bidModelArrayList.get(position);
    ...
    private class BidDateFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence != null && charSequence.toString().length() > 0) {
                ArrayList<BidModel> arrayList1 = new ArrayList<>();

                for (int i = 0, l = bidModels.size(); i < l; i++) {
                    BidModel subject = bidModels.get(i);
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            ...
            bidModelArrayList = (ArrayList<BidModel>) filterResults.values;
