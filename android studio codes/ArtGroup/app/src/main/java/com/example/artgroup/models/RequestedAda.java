...
public class RequestedAda extends ArrayAdapter<RequestedM> {
    public ArrayList<RequestedM> bidModels;
    public ArrayList<RequestedM> bidModelArrayList;
    public RequestedAda.BidDateFilter bidDateFilter;

    public RequestedAda(Context context, int id, ArrayList<RequestedM> subjectArrayList) {
