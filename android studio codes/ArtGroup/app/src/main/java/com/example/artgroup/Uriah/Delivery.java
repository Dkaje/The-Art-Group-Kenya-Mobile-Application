    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(((adapterView, view, i, l) -> {
            ...
            alertDialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(view1 -> {
                ...
                alert.setMessage("Hi " + bidModel.getCust_name() + ",\nBy Clicking CONFIRM\nYou agree that your product was Delivered Successfully\nDo you want to proceed?");
                            ...
                            try {
                                ...
                                if (success == 1) {
                                    ...
                                    for (int h = 0; h < jsonArray.length(); h++) {
                                        ...
                                        cartAda = new CartAda(Delivery.this, R.layout.marathon, cartModArrayList);
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            bidAda = new FinalDAda(Delivery.this, R.layout.marathon, bidModelArrayList);
