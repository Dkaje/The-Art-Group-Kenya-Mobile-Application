...
public class OneAda extends ArrayAdapter<OneModel> {
    public ArrayList<OneModel> bidModels;
    public ArrayList<OneModel> bidModelArrayList;
    public OneAda.BidDateFilter bidDateFilter;

    public OneAda(Context context, int id, ArrayList<OneModel> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(R.layout.locale, null);
        ...
        OneModel subject = bidModelArrayList.get(position);
        holder.SubjectQuantity.setText(subject.getClassification());
        return convertView;
    }
    ...
    private class BidDateFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence != null && charSequence.toString().length() > 0) {
                ArrayList<OneModel> arrayList1 = new ArrayList<>();

                for (int i = 0, l = bidModels.size(); i < l; i++) {
                    OneModel subject = bidModels.get(i);
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            ...
            bidModelArrayList = (ArrayList<OneModel>) filterResults.values;
