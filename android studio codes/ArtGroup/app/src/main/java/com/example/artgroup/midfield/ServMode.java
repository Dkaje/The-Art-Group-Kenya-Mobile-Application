...
public class ServMode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_serv_mode);
        ...
        txtRegist.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), ServReg.class));
            finish();
        });
        txtForgot.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), ServReset.class));
            finish();
        });
