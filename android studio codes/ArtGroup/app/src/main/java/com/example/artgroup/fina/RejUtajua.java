...
public class RejUtajua extends AppCompatActivity {
    FinaSess custSess;
    UserModel userModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rej_utajua);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (mSpinner.equals("New")) {
                    ...
                    if (bidModelArrayList.isEmpty()) {
                        Toast.makeText(RejUtajua.this, "You have nothing to print!!!", Toast.LENGTH_SHORT).show();
                    } else {
                        printThis();
                    }
                }
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            bidAda = new RecentAda(RejUtajua.this, R.layout.marathon, bidModelArrayList);
