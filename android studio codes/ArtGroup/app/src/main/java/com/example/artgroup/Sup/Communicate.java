...
public class Communicate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnRoster).setOnClickListener(view -> {
            ...
            ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.Sup, android.R.layout.simple_spinner_item);
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            wadaAda = new WadaAda(Communicate.this, R.layout.okay, wadawidaArrayList);
