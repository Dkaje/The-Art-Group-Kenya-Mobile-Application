...
public class HistVide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hist_vide);
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            seeker = new Seeker(HistVide.this, R.layout.marathon, bidModelArrayList);
