...
import com.example.artgroup.drive.DriMess;
import com.example.artgroup.drive.Shipping;
...
public class DrivDash extends AppCompatActivity {
    DrivSess custSess;
    UserModel userModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driv_dash);//upcoming
        ...
        botaz.setSelectedItemId(R.id.upcoming);
        ...
        listView.setOnItemClickListener(((adapterView, view, i, l) -> {
            ...
            alertDialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(view1 -> {
                ...
                otis.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(view1r -> {
                    ...
                    requestQueue.add(new StringRequest(Request.Method.POST, ModelUrl.updatD,
                            response -> {
                                try {
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            bidAda = new ReviAda(DrivDash.this, R.layout.marathon, bidModelArrayList);
