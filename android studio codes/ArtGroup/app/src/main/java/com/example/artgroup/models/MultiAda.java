...
public class MultiAda extends ArrayAdapter<ReviMode> {
    public ArrayList<ReviMode> MainList;
    public ArrayList<ReviMode> SubjectListTemp;
    public MultiAda.SubjectDataFilter subjectDataFilter;

    public MultiAda(Context context, int id, ArrayList<ReviMode> subjectArrayList) {
