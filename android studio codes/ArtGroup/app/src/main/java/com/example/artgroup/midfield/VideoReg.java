...
public class VideoReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.Video, android.R.layout.simple_spinner_item);
        ...
        btn.setOnClickListener(v -> {
            ...
            if (mFname.isEmpty()) {
                ...
                Toast.makeText(this, "Password must be 4 digit number", Toast.LENGTH_SHORT).show();
