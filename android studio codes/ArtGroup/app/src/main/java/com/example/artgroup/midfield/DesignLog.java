...
public class DesignLog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_design_log);
        ...
        txtRegist.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), DesignReg.class));
            finish();
        });
        txtForgot.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), DesignReset.class));
            finish();
        });
