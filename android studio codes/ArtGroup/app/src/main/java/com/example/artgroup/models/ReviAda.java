...
public class ReviAda extends ArrayAdapter<ReviMode> {
    public ArrayList<ReviMode> MainList;
    public ArrayList<ReviMode> SubjectListTemp;
    public ReviAda.SubjectDataFilter subjectDataFilter;

    public ReviAda(Context context, int id, ArrayList<ReviMode> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.stat.setText(subject.getDrive());
        return convertView;
    }
