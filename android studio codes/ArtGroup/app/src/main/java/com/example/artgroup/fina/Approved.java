            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (mSpinner.equals("New")) {
                    ...
                    if (bidModelArrayList.isEmpty()) {
                        Toast.makeText(Approved.this, "You have nothing to print!!!", Toast.LENGTH_SHORT).show();
                    } else {
                        printThis();
                    }
                }
                            ...
                            try {
                                ...
                                if (success == 1) {
                                    ...
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        ...
                                        cartAda = new CartAda(Approved.this, R.layout.marathon, cartModArrayList);
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            bidAda = new PayAda(Approved.this, R.layout.marathon, bidModelArrayList);
