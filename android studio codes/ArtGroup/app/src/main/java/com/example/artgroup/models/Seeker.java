...
public class Seeker extends ArrayAdapter<ReviMode> {
    public ArrayList<ReviMode> MainList;
    public ArrayList<ReviMode> SubjectListTemp;
    public Seeker.SubjectDataFilter subjectDataFilter;

    public Seeker(Context context, int id, ArrayList<ReviMode> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        pos++;
        holder.amount.setText(subject.getCust_phone());
