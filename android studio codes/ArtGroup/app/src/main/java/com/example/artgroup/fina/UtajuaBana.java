...
public class UtajuaBana extends AppCompatActivity {
    FinaSess custSess;
    UserModel userModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_utajua_bana);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (mSpinner.equals("New")) {
                    ...
                    if (bidModelArrayList.isEmpty()) {
                        Toast.makeText(UtajuaBana.this, "You have nothing to print!!!", Toast.LENGTH_SHORT).show();
                    } else {
                        printThis();
                    }
                }
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            alertDialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(view1 -> {
                ...
                requestQueue.add(new StringRequest(Request.Method.POST, ModelUrl.mucii,
                        response -> {
                            try {
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            bidAda = new RecentAda(UtajuaBana.this, R.layout.marathon, bidModelArrayList);
