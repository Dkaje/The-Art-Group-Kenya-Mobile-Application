...
public class SupHis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sup_his);
    ...
    private void getSupp() {
        ...
        requestQueue.add(new StringRequest(Request.Method.POST, ModelUrl.npends,
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            bidAda = new SupAda(SupHis.this, R.layout.marathon, bidModelArrayList);
