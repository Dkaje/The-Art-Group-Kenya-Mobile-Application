...
public class Murife extends ArrayAdapter<RequestedM> {
    public ArrayList<RequestedM> bidModels;
    public ArrayList<RequestedM> bidModelArrayList;
    public Murife.BidDateFilter bidDateFilter;

    public Murife(Context context, int id, ArrayList<RequestedM> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(R.layout.okay, null);
        ...
        RequestedM subject = bidModelArrayList.get(position);
        holder.SubjectQuantity.setText(subject.getCategory());
        holder.subjecType.setText("Type: " + subject.getType());
        Glide.with(convertView).load(subject.getImage_desgn()).into(holder.imageView);
        return convertView;
    }
    ...
    private class BidDateFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence != null && charSequence.toString().length() > 0) {
                ...
                for (int i = 0, l = bidModels.size(); i < l; i++) {
                    RequestedM subject = bidModels.get(i);
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            ...
            bidModelArrayList = (ArrayList<RequestedM>) filterResults.values;
