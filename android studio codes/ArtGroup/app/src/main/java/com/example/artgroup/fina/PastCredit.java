...
public class PastCredit extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_past_credit);
    ...
    private void getCredit() {
        ...
        requestQueue.add(new StringRequest(Request.Method.POST, ModelUrl.sawa,
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            credAda = new PesaAda(PastCredit.this, R.layout.render, credModArrayList);
