...
public class DriMess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dri_mess);
        ...
        findViewById(R.id.btnRoster).setOnClickListener(view -> {
            ...
            ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.Dri, android.R.layout.simple_spinner_item);
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            wadaAda = new WadaAda(DriMess.this, R.layout.okay, wadawidaArrayList);
