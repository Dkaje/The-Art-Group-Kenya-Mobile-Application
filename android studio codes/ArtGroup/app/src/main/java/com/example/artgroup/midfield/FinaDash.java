...
import com.example.artgroup.fina.Approved;
import com.example.artgroup.fina.Creditors;
import com.example.artgroup.fina.Investment;
import com.example.artgroup.fina.MessageFina;
import com.example.artgroup.fina.Rejected;
import com.example.artgroup.fina.ServPe;
import com.example.artgroup.fina.UtajuaBana;
...
public class FinaDash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaz.setSelectedItemId(R.id.ready);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (mSpinner.equals("New")) {
                    ...
                    if (bidModelArrayList.isEmpty()) {
                        Toast.makeText(FinaDash.this, "You have nothing to print!!!", Toast.LENGTH_SHORT).show();
                    } else {
                        printThis();
                    }
                }
        ...
        findViewById(R.id.chatTex).setOnClickListener(view -> {
            startActivity(new Intent(getApplicationContext(), MessageFina.class));
        });
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            alertDialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(view1 -> {
                ...
                requestQueue.add(new StringRequest(Request.Method.POST, ModelUrl.updateTilo,
                        response -> {
                            try {
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        para.put("payid", bidModel.getPayid());
                        para.put("comment", "Thanks for shopping with us. Welcome Back");
                        para.put("status", "1");
                        para.put("amount", bidModel.getAmount());
                            ...
                            try {
                                ...
                                if (success == 1) {
                                    ...
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        ...
                                        cartAda = new CartAda(FinaDash.this, R.layout.marathon, cartModArrayList);
    ...
    private void getRecords() {
        requestQueue = Volley.newRequestQueue(this);
        requestQueue.add(new StringRequest(Request.Method.POST, ModelUrl.malingo,
                response -> {
                    try {
                        jsonObject = new JSONObject(response);
                        int success = jsonObject.getInt("trust");
                        if (success == 1) {
                            ...
                            bidAda = new PayAda(FinaDash.this, R.layout.marathon, bidModelArrayList);
