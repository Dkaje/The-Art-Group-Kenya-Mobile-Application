...
public class RecentMode {
    ...
    public RecentMode(String payid, String entry, String mpesa, String amount, String orders, String ship, String custid, String name, String phone, String location, String landmark, String status, String comment, String design, String disb, String reg_date) {
        this.payid = payid;
        this.entry = entry;
        this.mpesa = mpesa;
        this.amount = amount;
