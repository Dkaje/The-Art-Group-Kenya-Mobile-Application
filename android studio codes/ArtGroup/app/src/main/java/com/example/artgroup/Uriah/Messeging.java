...
public class Messeging extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnRoster).setOnClickListener(view -> {
            ...
            ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.Rec, android.R.layout.simple_spinner_item);
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            wadaAda = new WadaAda(Messeging.this, R.layout.okay, wadawidaArrayList);
