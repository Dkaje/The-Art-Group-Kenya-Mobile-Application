...
public class VideoGrapher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtRegist.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), VideoReg.class));
            finish();
        });
        txtForgot.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), VideoReser.class));
            finish();
        });
