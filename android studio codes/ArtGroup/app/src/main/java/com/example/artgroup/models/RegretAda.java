...
public class RegretAda extends ArrayAdapter<PayerSe> {
    public ArrayList<PayerSe> MainList;
    public ArrayList<PayerSe> SubjectListTemp;
    public RegretAda.SubjectDataFilter subjectDataFilter;

    public RegretAda(Context context, int id, ArrayList<PayerSe> subjectArrayList) {
